...
const Cart = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between py-4 pb-5 px-6">
        <motion.i
          {...buttonClick}
          className="cursor-pointer"
          onClick={() => dispatch(setCartOff())}
        >
          <BiChevronsRight className="text-[20px] text-textColor" />
        </motion.i>
      ...
      <div className="flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc-900 h-full py-6  gap-3 relative">
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className="bg-zinc-800 rounded-t-[60px] w-full h-[35%] flex flex-col items-center px-4 py-6 gap-6">
              ...
              <motion.button
                {...buttonClick}
                className="bg-orange-400 w-[70%] px-2 py-2 text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md rounded-2xl"
